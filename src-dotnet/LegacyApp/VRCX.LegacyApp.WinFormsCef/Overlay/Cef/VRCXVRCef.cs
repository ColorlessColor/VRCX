...
using VRCX.LegacyApp.WinFormsCef.Overlay.OpenVR;
    ...
    public class VRCXVRCef : VRCXVRInterface
    {
        ...
        private void SetupTextures()
        {
            unsafe
            {
                ...
                _adapter.Dispose();
                SilkMarshal.ThrowHResult(_factory.EnumAdapters((uint)OpenVR.OpenVR.System.GetD3D9AdapterIndex(),
                    ref _adapter));
        ...
        private void ThreadLoop()
        {
            ...
            var overlayIndex = OpenVR.OpenVR.k_unTrackedDeviceIndexInvalid;
            ...
            while (_thread != null)
            {
                ...
                if (_active)
                {
                    var system = OpenVR.OpenVR.System;
                    if (system == null)
                    {
                        ...
                        system = OpenVR.OpenVR.Init(ref _err, EVRApplicationType.VRApplication_Background);
                    ...
                    if (system != null)
                    {
                        ...
                        {
                            overlayIndex = OpenVR.OpenVR.k_unTrackedDeviceIndexInvalid;
                            UpdateDevices(system, ref overlayIndex);
                            if (overlayIndex != OpenVR.OpenVR.k_unTrackedDeviceIndexInvalid)
                            {
                        ...
                        var overlay = OpenVR.OpenVR.Overlay;
                        if (overlay != null)
                        {
        ...
        public override void SetActive(bool active, bool hmdOverlay, bool wristOverlay, bool menuButton, int overlayHand)
        {
            ...
            {
                OpenVR.OpenVR.Overlay.DestroyOverlay(_hmdOverlayHandle);
                _hmdOverlayHandle = 0;
            }
            ...
            {
                OpenVR.OpenVR.Overlay.DestroyOverlay(_wristOverlayHandle);
                _wristOverlayHandle = 0;
            }
        ...
        private void UpdateDevices(CVRSystem system, ref uint overlayIndex)
        {
            ...
            var poses = new TrackedDevicePose_t[OpenVR.OpenVR.k_unMaxTrackedDeviceCount];
            system.GetDeviceToAbsoluteTrackingPose(ETrackingUniverseOrigin.TrackingUniverseStanding, 0, poses);
            for (var i = 0u; i < OpenVR.OpenVR.k_unMaxTrackedDeviceCount; ++i)
            {
        ...
        internal EVROverlayError ProcessOverlay2(CVROverlay overlay, ref ulong overlayHandle, ref bool overlayVisible, bool dashboardVisible)
        {
            ...
            if (overlayHandle == 0)
            {
                ...
                if (err != EVROverlayError.None)
                {
                    ...
                    err = overlay.SetOverlayTransformTrackedDeviceRelative(overlayHandle, OpenVR.OpenVR.k_unTrackedDeviceIndex_Hmd, ref hm34);
                    if (err != EVROverlayError.None)
                    {
                        return err;
                    }
