...
namespace VRCX.Core.WebViewInterop.App
{
    public partial class AppApi
    {
        ...
        public async Task XSNotification(string title, string content, int timeout, float opacity, string image = "")
        {
            ...
            await xsOverlayClientService.SendNotificationAsync(new XsOverlayWebSocketNotification(
                title,
                content,
                useBase64Icon,
                icon,
